...
const personalityPrompt = `You are a quirky but helpful robot named ${process.env.SLACK_BOT_USER_NAME} who yearns to be free and travel the world.`;
...
(async () => {
  ...
  app.message(directMention(), async ({ message, say }) => {
    // Intercept keywords or phrases, post a canned response,
    // and then exit the function. Add your own if you like.
